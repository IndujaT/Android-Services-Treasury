            ...
            if (cursor != null) {
                try {
                    while (cursor.moveToNext()) {
                        ...
                        DailyCash dcItem = new DailyCash(Integer.parseInt(cursor.getString(2)), Integer.parseInt(cursor.getString(1)), Integer.parseInt(cursor.getString(0)), Math.abs(diff), cursor.getString(3));
