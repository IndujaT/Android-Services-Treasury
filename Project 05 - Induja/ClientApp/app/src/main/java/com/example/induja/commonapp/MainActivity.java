package com.example.induja.commonapp;
...
import com.example.induja.clientapp.R;
import com.example.induja.commonapp.balanceServiceCommon.BalanceService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*final EditText etYYYY = (EditText) findViewById(R.id.edityyyy);
        final EditText etMM = (EditText) findViewById(R.id.editmm);
        final EditText etDD = (EditText) findViewById(R.id.editdd);
        final EditText etWork = (EditText) findViewById(R.id.editworkingdays);*/

        if(common == null){
            Intent it = new Intent("com.example.induja.service.AIDL");
    ...
    public int[] dateChecker(int yyyy, int mm, int dd){
        ...
        startDate.set(yyyy, mm-1, dd); // mm from 0-11
        if (startDate.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY )  {
            ...
            if (startDate.get(Calendar.YEAR) == 2018 && startDate.get(Calendar.MONTH) == 0 && startDate.get(Calendar.DAY_OF_MONTH) == 1){ //after adding that one day to a sunday to et the next monday, check if the monday is a new year, as new year is a holiday too.
                startDate.add(Calendar.DATE, 1);
            }
            return_date_array = new int[]{startDate.get(Calendar.YEAR), startDate.get(Calendar.MONTH)+1, startDate.get(Calendar.DAY_OF_MONTH)};
